...
return {
    ...
    AUTOROUTE_LOOP = 'Loop path',
    AUTOROUTE_ADD_WAYPOINT = 'Add Waypoint',
    AUTOROUTE_CLEAR_WAYPOINTS = 'Clear',
    AUTOROUTE_WAYPOINTS = 'Waypoint %d/%d',
    AUTOROUTE_REMOVE_LAST = 'Remove Last',
    AUTOROUTE_NEAREST = 'Nearest',
    AUTOROUTE_SAVE_ROUTE = 'Save Route',
    AUTOROUTE_LOAD_ROUTE = 'Load Route',
    AUTOROUTE_READOUT = 'Live Readout',
    AUTOROUTE_DISTANCE = 'Distance',
    AUTOROUTE_ANGLE = 'Angle to target',
    AUTOROUTE_ETA = 'ETA',
    AUTOROUTE_ETA_NA = 'unreachable',
    AUTOROUTE_PATH_LEN = 'Path: %s / %s remaining',
    AUTOROUTE_OVERLAY = 'Overlay',
    AUTOROUTE_IMPORT_CLIPBOARD = 'Import from Clipboard',
    AUTOROUTE_EDIT = 'Edit Waypoints',
    AUTOROUTE_NO_WAYPOINTS = 'No waypoints',
    AUTOROUTE_DELETE = 'Del',
    AUTOROUTE_INSERT = 'Insert',
    AUTOROUTE_SET_ACTIVE = 'Set Active',
...
This action cannot be undone.
    ...
    VARWATCH_DIST_TO_TARGET = 'Dist to Target: %s',
    VARWATCH_ANGLE_TO_TARGET = 'Angle to Target: %s',
    -- Memory addresses
    ADDRESS_USA = 'USA',
    ADDRESS_JAPAN = 'Japan',
