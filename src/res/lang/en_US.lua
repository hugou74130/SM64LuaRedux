...
return {
    ...
    SEMANTIC_WORKFLOW_PROJECT_BRUTEFORCE_STOP = 'Stop',
    SEMANTIC_WORKFLOW_PROJECT_BRUTEFORCE_TOOL_TIP =
    'Bruteforce the current sheet (just played to its end) to shave frames off the action, then Apply in the Bruteforce tab to chain the next action from the faster state',
...
This action cannot be undone.
    ...
    BRUTEFORCE_SET_START = 'Set start',
    BRUTEFORCE_START_SET = 'start: set',
    BRUTEFORCE_START_UNSET = 'start: not set',
    BRUTEFORCE_SET_GOAL = 'Set goal (action)',
    BRUTEFORCE_GOAL_RADIUS = 'Goal radius (0 = auto)',
    BRUTEFORCE_RADIUS = 'radius:',
    BRUTEFORCE_BLOCKED = 'refused at goal:',
    BRUTEFORCE_BY_SPEED = 'speed',
    BRUTEFORCE_BY_ANGLE = 'angle',
    BRUTEFORCE_CHUNKS = 'Chunks (split long segments)',
    BRUTEFORCE_GOAL = 'goal:',
    BRUTEFORCE_GOAL_UNSET = 'goal: not set',
    BRUTEFORCE_PERTURB_CHANCE = 'Perturb chance %',
    BRUTEFORCE_PERTURB_MAGNITUDE = 'Perturb magnitude',
    BRUTEFORCE_APPLY_TO_SHEET = 'Apply to sheet',
    BRUTEFORCE_STATUS_SHEET_APPLIED = 'Applied to the sheet.',
    BRUTEFORCE_ERROR_SHEET_NOT_READY = 'Run the sheet to its end first, then bruteforce.',
    BRUTEFORCE_BUDGET = 'Max candidates',
    BRUTEFORCE_BEST = 'best:',
    BRUTEFORCE_REFERENCE = 'ref:',
    BRUTEFORCE_GAIN = 'gain:',
    BRUTEFORCE_TRIED = 'tried:',
    BRUTEFORCE_NICHES = 'niches:',
    BRUTEFORCE_SPEED = 'speed@goal:',
    BRUTEFORCE_SHAKE = 'shake:',
    BRUTEFORCE_REACHES = 'reached:',
    BRUTEFORCE_SWEEP = 'sweep:',
    BRUTEFORCE_MISS = 'closest miss:',
    BRUTEFORCE_END_DIST = 'ends from goal:',
    BRUTEFORCE_CHAIN = 'chain:',
    BRUTEFORCE_CHAIN_FREE = 'free',
    BRUTEFORCE_CHAIN_LOCKED = 'locked (end state preserved)',
    BRUTEFORCE_GOAL_NEVER_REACHED = 'The goal is NEVER reached — no gain is possible. Widen the radius or re-set the goal.',
    BRUTEFORCE_STATUS_CONVERGED = 'Converged — likely optimal for this budget.',
    BRUTEFORCE_APPLY_BEST = 'Apply best',
    BRUTEFORCE_EXPORT_M64 = 'Export .m64',
    BRUTEFORCE_STATUS_IDLE = 'Idle.',
    BRUTEFORCE_STATUS_CAPTURING = 'Measuring baseline...',
    BRUTEFORCE_STATUS_SEARCHING = 'Searching for fewer frames...',
    BRUTEFORCE_STATUS_STOPPED = 'Stopped.',
    BRUTEFORCE_STATUS_DONE = 'Search finished.',
    BRUTEFORCE_STATUS_VERIFYING = 'Verifying the reconstructed run...',
    BRUTEFORCE_ERROR_CHUNK_DRIFT = 'Chunks drifted: the reconstructed run misses the goal. Use fewer chunks or a tighter radius.',
    BRUTEFORCE_ERROR_VERIFY_FAILED = 'Result did not reproduce the goal on verification — discarded (nothing applied).',
    BRUTEFORCE_ERROR_NOT_VERIFIED = 'Result not verified yet — let the verification finish before applying.',
    BRUTEFORCE_STATUS_APPLIED = 'Best written to bruteforce_result.txt (and clipboard).',
    BRUTEFORCE_STATUS_M64_EXPORTED = 'Wrote <movie>.bruteforced.m64 next to your movie.',
    BRUTEFORCE_ERROR_NOT_READY = 'Set a start state and a goal action first.',
    BRUTEFORCE_ERROR_GOAL_NOT_REACHED = 'Baseline never reached the goal action (check the goal / that the movie replays your action).',
    BRUTEFORCE_ERROR_NO_RESULT = 'No result to apply yet.',
    BRUTEFORCE_ERROR_NO_GAIN = 'No improvement found — nothing to save.',
    BRUTEFORCE_ERROR_NO_MOVIE = 'Open a movie first (its header is copied to make a valid .m64).',
    BRUTEFORCE_ERROR_WRITE_FAILED = 'Could not write the .m64 file.',
    -- Varwatch
