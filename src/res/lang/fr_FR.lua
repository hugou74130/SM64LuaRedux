...
Cette action est irréversible.
    ...
    SEMANTIC_WORKFLOW_INPUTS_MERGE_SECTION = 'Fusionner suivante',
    ...
    SEMANTIC_WORKFLOW_CONTROL_SCALE_MAG_APPLY = 'Mis. \xc3\xa0 l\xe2\x80\x99\xc3\xa9ch.\xe2\x86\x92s\xc3\xa9l',
    ...
    SEMANTIC_WORKFLOW_PREFERENCES_DESELECT_ALL = 'Tout désélectionner',
