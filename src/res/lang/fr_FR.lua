...
return {
    ...
    SEMANTIC_WORKFLOW_PROJECT_BRUTEFORCE = 'Bruteforce',
    SEMANTIC_WORKFLOW_PROJECT_BRUTEFORCE_STOP = 'Arrêter',
    SEMANTIC_WORKFLOW_PROJECT_BRUTEFORCE_TOOL_TIP =
    "Bruteforce la sheet courante (qui vient d'être jouée jusqu'au bout) pour gratter des frames sur l'action, puis Appliquer dans l'onglet Bruteforce pour enchaîner l'action suivante depuis l'état plus rapide",
...
Cette action est irréversible.
    ...
    TIMER_AUTO = 'Auto',
    -- Bruteforce
    BRUTEFORCE_TAB_NAME = 'Bruteforce',
    BRUTEFORCE_SET_START = 'Définir départ',
    BRUTEFORCE_START_SET = 'départ : défini',
    BRUTEFORCE_START_UNSET = 'départ : non défini',
    BRUTEFORCE_SET_GOAL = 'Définir but (action)',
    BRUTEFORCE_GOAL_RADIUS = 'Rayon du but (0 = auto)',
    BRUTEFORCE_RADIUS = 'rayon :',
    BRUTEFORCE_BLOCKED = 'refusé au but :',
    BRUTEFORCE_BY_SPEED = 'vitesse',
    BRUTEFORCE_BY_ANGLE = 'angle',
    BRUTEFORCE_CHUNKS = 'Chunks (découper long segment)',
    BRUTEFORCE_GOAL = 'but :',
    BRUTEFORCE_GOAL_UNSET = 'but : non défini',
    BRUTEFORCE_PERTURB_CHANCE = 'Proba perturbation %',
    BRUTEFORCE_PERTURB_MAGNITUDE = 'Amplitude perturbation',
    BRUTEFORCE_APPLY_TO_SHEET = 'Appliquer à la sheet',
    BRUTEFORCE_STATUS_SHEET_APPLIED = 'Appliqué à la sheet.',
    BRUTEFORCE_ERROR_SHEET_NOT_READY = "Joue la sheet jusqu'au bout d'abord, puis bruteforce.",
    BRUTEFORCE_BUDGET = 'Candidats max',
    BRUTEFORCE_BEST = 'meilleur :',
    BRUTEFORCE_REFERENCE = 'réf :',
    BRUTEFORCE_GAIN = 'gain :',
    BRUTEFORCE_TRIED = 'essais :',
    BRUTEFORCE_NICHES = 'niches :',
    BRUTEFORCE_SPEED = 'vitesse au but :',
    BRUTEFORCE_SHAKE = 'secousse :',
    BRUTEFORCE_REACHES = 'atteintes :',
    BRUTEFORCE_SWEEP = 'balayage :',
    BRUTEFORCE_MISS = 'écart mini :',
    BRUTEFORCE_END_DIST = 'finit à :',
    BRUTEFORCE_CHAIN = 'chaîne :',
    BRUTEFORCE_CHAIN_FREE = 'libre',
    BRUTEFORCE_CHAIN_LOCKED = 'verrouillée (état de fin préservé)',
    BRUTEFORCE_GOAL_NEVER_REACHED = "Le but n'est JAMAIS atteint — aucun gain possible. Élargis le rayon ou redéfinis le but.",
    BRUTEFORCE_STATUS_CONVERGED = 'Convergé — probablement optimal pour ce budget.',
    BRUTEFORCE_APPLY_BEST = 'Appliquer le meilleur',
    BRUTEFORCE_EXPORT_M64 = 'Exporter .m64',
    BRUTEFORCE_STATUS_IDLE = 'Inactif.',
    BRUTEFORCE_STATUS_CAPTURING = 'Mesure de la référence...',
    BRUTEFORCE_STATUS_SEARCHING = 'Recherche de moins de frames...',
    BRUTEFORCE_STATUS_STOPPED = 'Arrêté.',
    BRUTEFORCE_STATUS_DONE = 'Recherche terminée.',
    BRUTEFORCE_STATUS_VERIFYING = 'Vérification de la run reconstruite...',
    BRUTEFORCE_ERROR_CHUNK_DRIFT = 'Dérive des chunks : la run reconstruite rate le but. Moins de chunks ou rayon plus serré.',
    BRUTEFORCE_ERROR_VERIFY_FAILED = 'Le résultat ne reproduit pas le but à la vérification — écarté (rien appliqué).',
    BRUTEFORCE_ERROR_NOT_VERIFIED = "Résultat pas encore vérifié — laisse la vérification se terminer avant d'appliquer.",
    BRUTEFORCE_STATUS_APPLIED = 'Meilleur écrit dans bruteforce_result.txt (et presse-papier).',
    BRUTEFORCE_STATUS_M64_EXPORTED = '<movie>.bruteforced.m64 écrit à côté de ta movie.',
    BRUTEFORCE_ERROR_NOT_READY = 'Définis d\'abord un état de départ et une action-but.',
    BRUTEFORCE_ERROR_GOAL_NOT_REACHED = 'La référence n\'atteint jamais l\'action-but (vérifie le but / que la movie rejoue ton action).',
    BRUTEFORCE_ERROR_NO_RESULT = 'Aucun résultat à appliquer pour l\'instant.',
    BRUTEFORCE_ERROR_NO_GAIN = 'Aucune amélioration trouvée — rien à sauver.',
    BRUTEFORCE_ERROR_NO_MOVIE = 'Ouvre d\'abord une movie (son header sert à faire un .m64 valide).',
    BRUTEFORCE_ERROR_WRITE_FAILED = 'Impossible d\'écrire le fichier .m64.',
