...
return {
    ...
    AUTOROUTE_LOOP = 'Boucler',
    AUTOROUTE_ADD_WAYPOINT = 'Ajouter point',
    AUTOROUTE_CLEAR_WAYPOINTS = 'Effacer',
    AUTOROUTE_WAYPOINTS = 'Point %d/%d',
    AUTOROUTE_REMOVE_LAST = 'Retirer dernier',
    AUTOROUTE_NEAREST = 'Plus proche',
    AUTOROUTE_SAVE_ROUTE = 'Sauver route',
    AUTOROUTE_LOAD_ROUTE = 'Charger route',
    AUTOROUTE_READOUT = 'Lecture en direct',
    AUTOROUTE_DISTANCE = 'Distance',
    AUTOROUTE_ANGLE = 'Angle vers la cible',
    AUTOROUTE_ETA = 'ETA',
    AUTOROUTE_ETA_NA = 'inatteignable',
    AUTOROUTE_PATH_LEN = 'Parcours : %s / %s restant',
    AUTOROUTE_OVERLAY = 'Overlay',
    AUTOROUTE_IMPORT_CLIPBOARD = 'Importer du presse-papier',
    AUTOROUTE_EDIT = 'Éditer les points',
    AUTOROUTE_NO_WAYPOINTS = 'Aucun point',
    AUTOROUTE_DELETE = 'Suppr',
    AUTOROUTE_INSERT = 'Insérer',
    AUTOROUTE_SET_ACTIVE = 'Activer',
...
Cette action est irréversible.
    ...
    VARWATCH_DIST_TO_TARGET = 'Distance cible : %s',
    VARWATCH_ANGLE_TO_TARGET = 'Angle cible : %s',
    -- Memory addresses
