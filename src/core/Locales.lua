...
---@field public SEMANTIC_WORKFLOW_PROJECT_BRUTEFORCE string
---@field public SEMANTIC_WORKFLOW_PROJECT_BRUTEFORCE_STOP string
---@field public SEMANTIC_WORKFLOW_PROJECT_BRUTEFORCE_TOOL_TIP string
...
---@field public BRUTEFORCE_TAB_NAME string
---@field public BRUTEFORCE_SET_START string
---@field public BRUTEFORCE_START_SET string
---@field public BRUTEFORCE_START_UNSET string
---@field public BRUTEFORCE_SET_GOAL string
---@field public BRUTEFORCE_GOAL_RADIUS string
---@field public BRUTEFORCE_CHUNKS string
---@field public BRUTEFORCE_GOAL string
---@field public BRUTEFORCE_GOAL_UNSET string
---@field public BRUTEFORCE_PERTURB_CHANCE string
---@field public BRUTEFORCE_PERTURB_MAGNITUDE string
---@field public BRUTEFORCE_APPLY_TO_SHEET string
---@field public BRUTEFORCE_STATUS_SHEET_APPLIED string
---@field public BRUTEFORCE_ERROR_SHEET_NOT_READY string
---@field public BRUTEFORCE_BUDGET string
---@field public BRUTEFORCE_BEST string
---@field public BRUTEFORCE_REFERENCE string
---@field public BRUTEFORCE_GAIN string
...
---@field public BRUTEFORCE_STATUS_CAPTURING string
---@field public BRUTEFORCE_STATUS_SEARCHING string
---@field public BRUTEFORCE_STATUS_STOPPED string
...
---@field public BRUTEFORCE_ERROR_NO_RESULT string
---@field public BRUTEFORCE_ERROR_NO_GAIN string
---@field public BRUTEFORCE_STATUS_M64_EXPORTED string
---@field public BRUTEFORCE_ERROR_NO_MOVIE string
---@field public BRUTEFORCE_ERROR_WRITE_FAILED string
