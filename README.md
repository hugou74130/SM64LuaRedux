...
- Auto-Route (Target Point steering)[^8]
...
[^8]: A movement mode that auto-steers Mario toward a chosen world coordinate, recomputing the optimal angle every frame. See [docs/AutoRoute.md](docs/AutoRoute.md)
